...
export default function CampusHopeSignup() {
  ...
  const handleSend = () => {
    ...
    const lines = [
      "🙋 Campus Hope — Sign Up",
      `Name: ${name.trim()}`,
      university.trim() ? `University: ${university.trim()}` : null,
      "",
      "I'd like to join the weekly Campus Hope outreach.",
    ...
    <section className="py-20 sm:py-24 px-6">
      <div className="max-w-2xl mx-auto">
        ...
        <p className="text-sm text-zinc-500 leading-relaxed mt-4 text-center max-w-md mx-auto">
          Sign up below and we&apos;ll reach out on WhatsApp with the next
        ...
        <div className="mt-10 bg-zinc-50 rounded-2xl border border-zinc-100 p-6 sm:p-8">
          ...
          <p className="text-xs text-zinc-400 text-center mt-4">
            This opens WhatsApp with your sign-up pre-filled — just hit send.
          </p>
        </div>
      </div>
    </section>
